...
//OnClickListener for sending and receiving OTP and getting permission for SMS and Call
            ...
            public void onClick(View v) {
                ...
                if(otp.equals(eotp)){
                    try {
                        ...
                        smsManager.sendTextMessage(mobile, null, "OTP to is : "+otp+" to register with Izzy Food Pantry", null, null);
    ...
    class RegisterUser extends AsyncTask<String, Void, String> {
        ...
        // Send toast when user register Successful
        @Override
        ...
        protected String doInBackground(String... params) {
            //verifying and register user and add customer details to database
