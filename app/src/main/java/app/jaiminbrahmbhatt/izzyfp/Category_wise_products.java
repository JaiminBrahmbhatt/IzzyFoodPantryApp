...
public class Category_wise_products extends AppCompatActivity implements AddorRemoveCallbacks {
    ...
    //Adding ProgressBar for products
    @Override
...
// checking cart count if it is empty or it has products
        ...
        class Products extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                //getting product details from product url
                try {
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    // getting products from MySQl database to JSONArray
                    ...
                    //getting products in JSONArray as JSONObject
                    ...
                    if (productArray.length() == 0) {
                        //Set product visible when cart is empty or has something
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.cart) {
            ...
            if (sp.getString("loginid", null) != null) {
                ...
                startActivity(i);
                return true;
                //AlertDialog if product added to cart but not logged in user
            } else {
                AlertDialog.Builder builder = new AlertDialog.Builder(Category_wise_products.this);
