...
public class AddToCart {
  ...
  // Adding product to Cart code using SharedPreferences
...
//Increment the cart image count for each unique product added to the cart
    public void addToCart(String pid,String qty) {

// Check if user is logged in to application or not
        String loginid = sp.getString("loginid", null);
        count=Integer.parseInt(qty);
        count++;

        // If logged in then AddToCart
...
// Toast when product added to cart
...
// concat products to the cart when you add more products to the cart
                    ...
                    try {
                        ...
                        // Getting product_id and qty from database
