...
public class Cart_Item_Adapter extends RecyclerView.Adapter<Cart_Item_Adapter.ProductsViewHolder> {
    ...
    //defining variales for product_id name desc image price brand and quantity
    ...
    //calling this pointer for product_id name desc image price brand and quantity
    ...
    //defining ViewHolder for product_id name desc image price brand and quantity
    @Override
...
//IncreaseProductQuantity defination after verifying login
            ...
            remove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (qtyi != 1) {
// function to decreaseProductQuantity from the cart
...
//Strikethrough for price when there is discount
